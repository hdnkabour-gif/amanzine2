...
| القياس | العدد |
|---|--:|
| ملفّاتٌ متتبَّعة | 732 |
| ملفّاتُ كود | 464 |
| أسطرُ كود | 87,296 |
| **يتيمة** (لا يبلغها مدخل) | **2** |
| صادراتٌ ميتةٌ بيقين | 215 |
...
|---|--:|--:|--:|
| عقلُ التطبيق | 92 | 15,374 | 89٪ |
| الصفحات | 51 | 20,121 | 10٪ |
| المكوّنات | 51 | 7,947 | 8٪ |
| مسارات الخادم | 33 | 5,948 | 36٪ |
| مكتباتُ الخادم | 45 | 4,111 | 93٪ |
| خدماتُ الخادم | 10 | 1,731 | 50٪ |
| الاختبارات | 94 | 13,624 | 100٪ |
| النصوص | 12 | 1,783 | 8٪ |
...
| `src/pages/LivingHome.tsx` | 1,101 |
| `src/pages/Storefront.tsx` | 1,067 |
| `server/migrate.js` | 952 |
