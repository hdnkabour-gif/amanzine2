...
|---|--:|--:|--:|
| عقلُ التطبيق | 94 | 15,568 | 89٪ |
| الصفحات | 51 | 20,210 | 10٪ |
| المكوّنات | 51 | 7,947 | 8٪ |
| مسارات الخادم | 33 | 6,009 | 36٪ |
| مكتباتُ الخادم | 46 | 4,282 | 93٪ |
| خدماتُ الخادم | 10 | 1,731 | 50٪ |
| الاختبارات | 98 | 14,986 | 100٪ |
| النصوص | 13 | 2,157 | 8٪ |
...
|---|--:|--:|
| `build-package.js` | 183 | منذ 5 يومًا |
| `sw.js` | 70 | منذ 5 يومًا |
...
| `server/migrate.js` | 1,140 |
| `src/pages/LivingHome.tsx` | 1,097 |
| `src/pages/Storefront.tsx` | 1,069 |
| `src/pages/MessagesPage.tsx` | 840 |
| `src/pages/OrdersPage.tsx` | 819 |
