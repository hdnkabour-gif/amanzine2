...
1. **مدنُ Livo لم تُقرأ قطّ** — الردُّ متداخل (`data.data`) والكودُ يتوقّع مصفوفة. ٤٤١ مدينة.
2. **`push` يقول «وصل» بلا مشترِك.**
3. **النسخُ الاحتياطيّة تُكتب فعلًا ثمّ تُمحى** مع كلّ نشر.
