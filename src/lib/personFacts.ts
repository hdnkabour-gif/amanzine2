...
const OWNS_SHOP = ['عندي محل', 'عندي حانوت', 'عندي دكان', 'عندي متجر', 'عندي بوتيك',
  ...
  // «مگازة» بالگاف المغربيّة — كتبها المالكُ هكذا، والمطبِّعُ يردّ الگاف كافًا
  // فلا تلتقي بـ«مغازه» أبدًا. حرفٌ واحدٌ كان يُسقط حقيقةً كاملة.
  'عندي مگازة', 'عندي ماگازة', 'عندي مكازة',
