...
const VERBS: { verb: ActionVerb; terms: string[] }[] = [
  ...
  //   **والنونُ تسقط في الكتابة السريعة.** قِيس من جملِ صاحب المشروع:
  //   «**في** وصلات الكوموند ديال طنجة» ⇒ «ما فهمتش مزيان»، بينما «فين
  //   وصلات…» تعمل. حرفٌ واحدٌ يفصل بين تتبّعِ طردٍ وبين لا شيء.
  //   وتبقى «وصل» المجرّدةُ خارجَ القائمة كما هي (انظر أعلاه): المركَّبُ
  //   يخصُّ التتبّعَ، والمفردُ يبتلع «وصلات» في كلّ جملة.
                            'فين وصلات', 'فين وصل', 'فين كاينه', 'واش وصل',
                            'في وصلات', 'واش وصلات', 'وصلات الكوموند', 'وصلات الطلب',
