...
const WORD: Record<string, string> = {
  ...
  // — إعداداتُ الحساب: النمرةُ والسميّة —
  //   من شاشة صاحب المشروع «bghit nebdel **nemra** deyali». والتحويلُ الحرفيُّ
  //   يعطي «نمرة» عاريةً و«smiya» يعطي «سمي**ي**ة» بياءَين (قاعدةُ `iya`) —
  //   وكلتاهما لا تُطابق شيئًا. وهذه الطبقةُ (كلماتٌ كاملة) هي موضعُ ما لا
  //   تصيبه القاعدةُ العامّة، فيُصحَّح السطحُ مرّةً هنا لا في كلّ قائمة.
  nemra: 'النمرة', nmra: 'النمرة', namra: 'النمرة', numero: 'النمرة',
  smiya: 'السمية', smia: 'السمية', ssmiya: 'السمية', smit: 'سمية',
  nebdel: 'نبدل', nbdel: 'نبدل', nbeddel: 'نبدل', kanbdel: 'كنبدل',
  // — تجارة / زبائن —
