...
const SECTIONS: GuideSection[] = [
  // ── DÉMARRAGE ──
  {
    // الشرح كان يبدأ بـ«أوّل عملية بيع» فيفترض أنّ القارئ بائع. هذا القسم يعيد
    // البداية إلى ما تفعله المنصّة فعلًا: تفهم حاجتك بأيّ لغة وتوصّلك.
    id: 'need', icon: Sparkles, title: 'قول شنو محتاج', tagline: 'أوّل خطوة: كلمة وحدة بأيّ لغة',
    color: '#0A8F6F', category: 'start', difficulty: 'beginner', timeToLearn: 'دقيقة',
    page: 'home',
    steps: [
      { t: '1) كتب بالدارجة أو بأيّ لغة', d: 'كتب «الما كيقطر» أو «bghit sbbak f casa» أو «je cherche un plombier» — أمانزين يفهم الدارجة والعربية والفرنسية والإنجليزية وحتى الحروف اللاتينية.', tip: 'ما تحتاجش تعرف الاسم الصحيح للمهنة — وصف المشكل يكفي' },
      { t: '2) صوّر المشكل 📷', d: 'إذا صعيب توصف، ضغط على زرّ الكاميرا فالمساعد وصوّر المشكل. أمانزين كيشوف الصورة ويستنتج المختصّ المناسب.', tip: 'هذه أسرع طريقة حين لا تعرف اسم القطعة أو العطب', action: { label: 'جرّب المساعد', page: 'assistant' } },
      { t: '3) نوصّلوك بالأقرب', d: 'أمانزين يرتّب المختصّين حسب القرب والتقييم والتوثيق و«مفتوح الآن» — ويعطيك هاتفهم للتواصل مباشرة.', tip: 'فعّل إذن الموقع باش يبان ليك الأقرب فعلًا' },
      { t: '4) تتبّع طلبك برقم هاتفك', d: 'ما عندكش حساب؟ ماشي مشكل — دخل رقم هاتفك ولا كود التتبّع باش تشوف حالة طلبك.', tip: 'التتبّع خدّام بلا تسجيل' },
    ],
    relatedIds: ['start', 'marketplace'],
  },
  {
    id: 'start', icon: Sparkles, title: 'البداية السريعة', tagline: 'قول شنو محتاج — وأمانزين يوجّهك',
