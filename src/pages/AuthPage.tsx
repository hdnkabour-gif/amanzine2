      ...
      <div style={{
          ...
          <div style={{
            ...
            {logoErr
              ...
              : <picture style={{ width: '100%', height: '100%', position: 'relative' }}>
                  <source srcSet="/brand/amanzine-logo.png" type="image/svg+xml" />
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            {/* Social Login */}
            {/* الزرُّ يظهر فقط إن كان المزوّدُ مُهيّأً فعلًا على الخادم. زرٌّ
                مفعَّلٌ يفشل عند النقر هو أسوأُ من غيابه: يَعِد ثمّ يخذل، ويظنّ
                المستخدمُ أنّ الخطأ منه. */}
            <div style={{ display: 'flex', gap: 8 }}>
              {socialCfg.googleClientId && <button type="button" onClick={googleLogin} disabled={socialBusy || !googleReady}
                style={{
              ...
              {socialCfg.facebookAppId && <button type="button" onClick={facebookLogin} disabled={socialBusy}
                style={{
                  flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                  padding: '12px', borderRadius: DS.radiusSm,
