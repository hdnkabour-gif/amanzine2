    ...
    <div style={{ padding: 20, maxWidth: 1100, margin: '0 auto' }}>
      ...
      {!loading && tab === 'bookings' && (
        <div>
          ...
          {bookings.length === 0 ? (
            <div style={{ color: 'var(--ink3)', fontSize: 13, lineHeight: 1.8 }}>
              <p>لا حجوزات بعد في سوق الخدمات.</p>
              {/* «حجز» كلمةٌ لنظامين: هذا جدولُ مقدّمي الخدمات، وذاك مواعيدُ
                  خدماتِ متجرك المستخرجةُ من الطلبات. التفريقُ هنا يمنع تناقضًا
                  ظاهريًّا: «٠ حجوزات» بينما تقويمُ الخدمات مملوء. */}
              <p style={{ fontSize: 12 }}>
                هذه حجوزاتُ <b>مقدّمي خدماتٍ خارجيّين</b> تُسجَّل من هنا.
                أمّا مواعيدُ خدمات متجرك فتأتي مع الطلبات، وتظهر في «تقويم الحجوزات» داخل صفحة الخدمات.
              </p>
            </div>
          ) : (
