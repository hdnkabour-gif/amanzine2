...
export const LX: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    seoTitle: 'AMANZINE — كل كلمة عندها طريق', seoDesc: 'أنشئ متجرك الإلكتروني، اعرض خدماتك، وبِع في السوق المغربي الموحّد — مع ذكاء اصطناعي وتوصيل آلي. مجاني للبدء.',
  ...
  darija: {
    ...
    seoTitle: 'AMANZINE — كل كلمة عندها طريق', seoDesc: 'دير متجرك، قدّم خدماتك، وبيع ف السوق المغربي الموحّد — مع ذكاء اصطناعي وتوصيل أوتوماتيك. بلاش باش تبدا.',
