...
db.discoverProducts = async ({ city, q, terms, limit = 24 } = {}) => {
  ...
  // ── **والمصطلحُ المركَّبُ يُفكَّك إلى كلماته** ──────────────────────
  //
  //   قِيس برحلةٍ كاملةٍ في متصفّحٍ حقيقيّ: منتجٌ اسمُه **«حوايج دراري صغار»**
  //   في القاعدة، والزبونُ يكتب «بغيت شي كسوة لبنتي أنا فكازة». فتُرسَل
  //   المرادفاتُ الصحيحةُ من المعرفة — ومنها «حوايج صغار» — ويرجع **صفر**.
  //
  //   والسببُ أنّ المطابقةَ `LIKE '%حوايج صغار%'` تطلب العبارةَ **متّصلة**،
  //   واسمُ المنتج يفصل بينهما بـ«دراري». فكلمتان صحيحتان في الاسم نفسِه لا
  //   تُطابقانه لأنّ بينهما ثالثة.
  //
  //   ولا أحدَ يسمّي بضاعتَه بالترتيب الذي يكتبه الباحث. فتُجرَّب العبارةُ
  //   كاملةً **وكلماتُها**: الأولى أدقُّ والثانيةُ تُنقذ حين تفشل.
  //
